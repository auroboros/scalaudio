...
import com.scalaudio.core.filter.GainFilter
import com.scalaudio.core.filter.mix.StereoPanner
import com.scalaudio.core.unitgen.{FuncGen, NoiseGen, SineGen, UnitGen}
